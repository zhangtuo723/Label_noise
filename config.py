...
parser.add_argument('--text_length', default=30, type=int, help='the number of words about the text to load')
...
parser.add_argument('--purity', default=0.85, type=float, help='粒球纯度')
parser.add_argument('--recluster',default=3,type=int,help='聚球次数')
parser.add_argument('--drop_ball',default=0.5,type=float,help='保留的球')
parser.add_argument('--noise_p',default=0.1,type=float,help='噪声比例')
