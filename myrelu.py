...
class GBNR(torch.autograd.Function):
    ...
    def forward(self, input_):
        ...
        return torch.Tensor(data), torch.Tensor(target), torch.tensor(sample_index), torch.tensor(index_chaifen_id)
  

    @staticmethod
    def backward(self, output_grad, input, index, id):
